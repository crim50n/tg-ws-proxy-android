...
data class ProxyConfig(
    ...
    val preconnectWebSockets: Boolean = true,
    val routeProbesEnabled: Boolean = true,
    val cfDomainRefreshEnabled: Boolean = true,
    val webSocketPingIntervalSeconds: Int = 30,
